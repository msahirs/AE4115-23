...
% PXX = pxx*fbin*NG/CG^2; % power spectral density [unit/Hz] (pxx multiplied with frequency bin width to get power of signal, see http://www.schmid-werren.ch/hanspeter/publications/2012fftnoise.pdf)
% display('coherent gain correction applied --> proper tonal amplitude results')

% PXX = pxx; % power spectral density [unit/Hz] (pxx multiplied with
% frequency bin width to get power of signal, see http://www.schmid-werren.ch/hanspeter/publications/2012fftnoise.pdf)
% display('coherent gain correction NOT applied --> proper background noise')

PXX = pxx*fbin; % power spectral density [unit/Hz] (pxx multiplied with frequency bin width to get power of signal, see http://www.schmid-werren.ch/hanspeter/publications/2012fftnoise.pdf)
